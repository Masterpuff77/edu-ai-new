          ...
          <div className="flex flex-col lg:flex-row min-h-[600px]">
            ...
            <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-slate-800 via-purple-800 to-indigo-800 relative overflow-hidden items-center justify-center p-8">
              ...
              <div className="absolute inset-0">
                <div className="absolute top-17 left-22 w-20 h-20 bg-white/10 rounded-full animate-pulse"></div>
              ...
              {/* Main colorful brain/education image */}
              <div className="relative z-10">
                <div className="w-80 h-80 rounded-3xl overflow-hidden shadow-2xl border-4 border-white/20">
                  <img 
                    src="-freepik__quare-11-vibrant-celebration-group-of-4-diverse-ro__79717_low.jpeg" 
