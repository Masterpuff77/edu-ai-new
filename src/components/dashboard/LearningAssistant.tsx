...
const LearningAssistant: React.FC = () => {
  ...
  if (initialLoading) {
    return (
      <div className="bg-gradient-to-br from-indigo-500 via-purple-600 to-pink-500 rounded-xl shadow-2xl overflow-hidden border-2 border-white/20 backdrop-blur-sm">
        <div className="p-6">
  ...
  return (
    <div className="bg-gradient-to-br from-indigo-500 via-purple-600 to-pink-500 rounded-xl shadow-2xl overflow-hidden border-2 border-white/20 backdrop-blur-sm transform hover:scale-[1.02] transition-all duration-300">
      ...
      <div className="relative p-6">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-white/80 text-sm">Powered by GPT-4 • Întotdeauna disponibil</p>
            </div>
          </div>
        ...
        <div className="bg-white/10 backdrop-blur-md rounded-xl p-4 mb-4 h-[400px] overflow-y-auto space-y-4 border border-white/20 shadow-inner">
          ...
          {loading && (
            <div className="flex justify-start">
              <div className="bg-white/20 backdrop-blur-sm text-white border border-white/10 rounded-xl p-3 max-w-[80%] shadow-lg">
        ...
        <form onSubmit={handleSubmit} className="relative">
          <div className="relative bg-white/10 backdrop-blur-md rounded-xl border border-white/20 shadow-lg">
            <input
              ...
              className="w-full pr-14 pl-4 py-3 bg-transparent text-white placeholder-white/60 rounded-xl focus:outline-none focus:ring-2 focus:ring-white/30 focus:border-white/40"
              disabled={loading}
            />
            <button
              type="submit"
