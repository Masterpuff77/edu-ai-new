      ...
      <div className="p-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <h3 className="text-xl font-bold text-white">Doamna Petrescu</h3>
              <p className="text-white/80 text-sm">Asistent virtual interactiv</p>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6">
          <p className="text-white/90 mb-6">
            Discută cu Doamna Petrescu, asistentul virtual care te poate ajuta cu întrebări despre educație și procesul de învățare.
          </p>
