    ...
    <div className="min-h-screen bg-gray-100 p-4">
      <div className="max-w-4xl mx-auto">
          ...
          {!conversationUrl ? (
            <div className="p-8 flex flex-col items-center justify-center">
              ...
              <p className="text-gray-600 mb-8 text-center max-w-md">
                Începe o conversație video interactivă cu asistentul virtual care te poate ajuta cu întrebări despre educație.
              </p>
        ...
        <div className="mt-6 p-4 bg-indigo-50 rounded-lg border border-indigo-100">
          <h3 className="text-lg font-medium text-indigo-800 mb-2">Despre Asistentul Virtual</h3>
          <p className="text-indigo-700">
            Asistentul virtual este creat cu tehnologia Tavus.io. Poate purta conversații naturale și poate răspunde la întrebări despre educație, oferind o experiență interactivă personalizată.
          </p>
        </div>
      </div>
    </div>
