/*
  # Add Computer Science Lessons for Bacalaureat

  1. Changes
    - Add 10 computer science lessons covering the Bacalaureat curriculum
    - Each lesson includes programming concepts, algorithms, and data structures
    - Lessons follow the Romanian Bacalaureat curriculum for Computer Science
